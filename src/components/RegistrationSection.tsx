...
import { Loader2, CheckCircle, UserPlus, Users, Calendar, Award, IndianRupee } from "lucide-react";
...
export const RegistrationSection = () => {
  ...
  return (
    <section id="registration" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-muted/30 to-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          {isSubmitted ? (
            <Card className="festival-card text-center border-green-500/30 bg-gradient-to-r from-green-500/5 to-emerald-500/5">
              <CardContent className="pt-6">
                <CheckCircle className="mx-auto h-16 w-16 text-green-500 mb-4" />
                <h3 className="text-2xl font-bold text-green-600 mb-2">Registration Successful!</h3>
                <p className="text-muted-foreground mb-4">
                  Thank you for registering for Discovery 2K25! 
